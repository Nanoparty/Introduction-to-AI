...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        livingGhostPositionDistributions = [beliefs for i,beliefs
                                            ...
                                            if livingGhosts[i+1]]
        "*** YOUR CODE HERE ***"
        distrib = [distribution.argMax() for distribution in livingGhostPositionDistributions]
        livingGhostsLikelyPositions = distrib
        gVals = [(self.distancer.getDistance(pacmanPosition, ghostPosition), ghostPosition) for ghostPosition in livingGhostsLikelyPositions]
        closestGhost = min(gVals)[1]
        vals = min(legal)
