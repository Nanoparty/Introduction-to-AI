...
class ValueIterationAgent(ValueEstimationAgent):
        ...
        for i in range(self.iterations):
            ...
            for s in states:
                ...
                for a in actions:
                    ...
                    for t in trans:
                        newV = t[1]*(self.mdp.getReward(s, a, t[0]) + self.discount * v[t[0]])
                        value += newV
    ...
    def computeQValueFromValues(self, state, action):
        ...
        for t in trans:
            newV = t[1]*(self.mdp.getReward(state, action, t[0]) + self.discount * self.values[t[0]])
            v += newV
        return v
    ...
    def computeActionFromValues(self, state):
        ...
        for a in actions:
            ...
            v = 0
            for t in trans:
                newV = t[1]*(self.mdp.getReward(state, a, t[0]) + self.discount * self.values[t[0]])
                v += newV
            if v > bestV:
                bestA = a
                bestV = v
